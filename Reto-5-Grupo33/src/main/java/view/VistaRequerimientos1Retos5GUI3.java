...
public class VistaRequerimientos1Retos5GUI3 extends javax.swing.JFrame {
    
    DefaultTableModel model;
    
    public VistaRequerimientos1Retos5GUI3() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaRequerimientos1Retos5GUI3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaRequerimientos1Retos5GUI3().setVisible(true);
            }
        });
    }
